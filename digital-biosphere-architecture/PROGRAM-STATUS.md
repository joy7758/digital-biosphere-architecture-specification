...
status: observed-governance-snapshot-dq-018-linux-arm64-reference-supplement-remote-verified-pr-g2a-pending
...
production_readiness_status: dq-018-linux-arm64-reference-validated-pr-g2a-pending-full-pr-g2-blocked-not-production-ready
...
CURRENT_ARCHITECTURE_MILESTONE=DQ-018-LINUX-ARM64-REFERENCE-VALIDATED-REMOTE-SUPPLEMENT-READY
...
DBOS_DQ018_BRANCH_TESTS_PASS=533
DBOS_DQ018_BRANCH_TELEMETRY_TESTS_PASS=199
...
DQ_018_EXACT_SOURCE_COMMIT=57c7b9e55dfcab84e81e7c5f61e9d8ea61045dbe
...
| `DBOS` | `main` + `codex/telemetry-admission-foundation` | main `cd3f867…`; DQ-018 source `57c7b9e…`; receipt `1c8f3d9…` | main 保持 Developer Preview；生产分支只实现离线 Telemetry Admission reference slice | Linux arm64 exact remote clean clone、533/533 tests、199/199 telemetry tests、30 validators PASS + 5 external-source fail closed、0 unexpected failures、TA-P001—P005 PASS | Linux arm64 reference supplement 已准备但 `PR-G2A` 未获人工批准；完整 `PR-G2` 与 production ready 均为 false |
...
| OpenTelemetry Observability Profile | `DQ_018_LINUX_ARM64_REFERENCE_VALIDATED_PR_G2A_REVIEW_READY` | DQ-022–025 exact references 已采纳；DBOS 无 listener 的 metadata-only 准入切片在 macOS arm64 与固定 Linux arm64 参考环境有回执；未部署 Collector 或 endpoint |
...
| Production Readiness | `DQ_018_LINUX_ARM64_REFERENCE_VALIDATED_PR_G2A_REVIEW_READY_FULL_PR_G2_BLOCKED` | exact offline slice 已通过固定 Linux arm64 clean clone、全量测试、安全扫描和一小时表征；PR-G2A 未批准；PR-G2B/G2T/G2I/G2C、DQ-019–021、其他平台、SAEE production isolation 和部署均未完成 |
...
- `DQ-018`：exact offline admission foundation 已增加固定 Linux arm64 remote clean-clone 验证；source `57c7b9e…`、receipt `1c8f3d9…`、manifest `d0951d6c…`；533/533 tests、199/199 telemetry tests、30 validators PASS + 5 external-source fail closed、0 unexpected failures、TA-P001—P005 及一小时 59/59 周期校验通过；当前仍等待 `PR-G2A Human Review`，不是完整 PR-G2；
...
1. 对 exact source `57c7b9e…`、receipt `1c8f3d9…`、manifest `d0951d6c…`、hardened packet 和 Linux arm64 reference supplement 执行 `PR-G2A Human Review`；
