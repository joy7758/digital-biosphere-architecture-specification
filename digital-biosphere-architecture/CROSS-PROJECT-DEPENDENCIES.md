...
| `DEP-018` | DBA human-decision readiness registry | ADR-024 / DQ-018 / DQ-022–DQ-025 / DQ-019–DQ-021 | `GOVERNANCE_GATE` | DQ-022–025、ADR-024、DQ-018、Linux arm64 原生 supplement 与 x86_64 模拟 `PARTIAL` supplement 已记录；当前等待 PR-G2A review | `DECISIONS_RECORDED_REMOTE_BASELINES_VERIFIED_X86_64_EMULATED_PARTIAL_PR_G2A_REVIEW_PENDING_NOT_APPROVED` | 注册表、supplement 或 Agent recommendation 自动关闭 review gate、把模拟升级为原生、选择 backend 或授权生产 |
