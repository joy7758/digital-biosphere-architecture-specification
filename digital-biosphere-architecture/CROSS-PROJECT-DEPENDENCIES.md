...
| `DEP-011` | OpenTelemetry SDK / Collector / OTLP | DBOS | `OBSERVATION_INPUT` | DQ-018 无 listener、metadata-only reference boundary 已在固定 Linux arm64 原生环境 PASS；当前 amd64 模拟功能/安全通过但 32-worker case 有 426 个 storage errors，原生 x86_64 未验证 | `DQ_018_LINUX_ARM64_NATIVE_PASS_X86_64_EMULATED_PARTIAL_PR_G2A_REVIEW_READY_NETWORK_AND_PRODUCTION_BLOCKED` | Version reference、emulation、load characterization 或 offline PASS 自动等于 SDK/Collector/runtime adoption；Telemetry 自动成为 Evidence、Verification、Truth、Permission 或 SAEE 评价结论 |
...
| `DEP-018` | DBA human-decision readiness registry | ADR-024 / DQ-018 / DQ-022–DQ-025 / DQ-019–DQ-021 | `GOVERNANCE_GATE` | DQ-022–025、ADR-024、DQ-018、Linux arm64 原生 supplement 与 x86_64 模拟 `PARTIAL` supplement 均已远端证明；当前等待 PR-G2A review | `DECISIONS_RECORDED_REMOTE_BASELINES_VERIFIED_X86_64_EMULATED_PARTIAL_REMOTE_ATTESTED_PR_G2A_REVIEW_PENDING_NOT_APPROVED` | 注册表、supplement 或 Agent recommendation 自动关闭 review gate、把模拟升级为原生、选择 backend 或授权生产 |
