...
| `DEP-018` | DBA human-decision readiness registry | ADR-024 / DQ-018 / DQ-022–DQ-025 / DQ-019–DQ-021 | `GOVERNANCE_GATE` | native validation/attestation 已完成；security precheck 发现 2 High + 2 Medium residuals，Human Security Review 未完成 | `SECURITY_PRECHECK_BLOCKED_REMEDIATION_OR_SCOPED_RISK_ACCEPTANCE_REQUIRED_PR_G2A_NOT_READY_NOT_APPROVED` | 注册表、supplement/attestation、native load PASS、0 automated findings 或 Agent recommendation 自动关闭 security/review gate、选择 backend 或授权生产 |
