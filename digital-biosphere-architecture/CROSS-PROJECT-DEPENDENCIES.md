...
| `DEP-018` | DBA human-decision readiness registry | ADR-024 / DQ-018 / DQ-022–DQ-025 / DQ-019–DQ-021 | `GOVERNANCE_GATE` | DQ-022–025、ADR-024 与 DQ-018 已记录；current source P001—P005 模拟重基线 receipt 已远端验证，native x86_64 与 current-source independent review packet 未完成 | `CURRENT_SOURCE_PACKET_REFRESH_REQUIRED_REMOTE_LOAD_REBASE_VERIFIED_PR_G2A_NOT_READY_NOT_APPROVED` | 注册表、supplement/attestation、full emulated load PASS 或 Agent recommendation 自动关闭 review gate、把模拟升级为原生、选择 backend 或授权生产 |
