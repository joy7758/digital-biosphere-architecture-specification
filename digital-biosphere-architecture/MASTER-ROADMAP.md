...
| `DP-5D` | Open-web discovery observation（开放网络发现观察） | DBA | `IN_PROGRESS` | `TMAI-OWD-20260722-001=NOT_OBSERVED`；GitHub metadata 已修复，尚未观察到重新索引 | 同一查询集复查或显式接受限制 |
...
NEXT_BLOCKER=B-010_DBOS_AGENT_ACCESS_UNDECIDED_AND_B-011_OPEN_WEB_NOT_OBSERVED
