...
| `DP-R` | Developer Preview Release Decision | DBA + Human Release Authority | `BLOCKED` | Agent Validation `PASS`；仍需 DBOS access decision、开放网络发现限制处理、`R-015` 复核和 `released_by_ref` | 处理 `B-010`、`B-011` 与 `DQ-009` |
