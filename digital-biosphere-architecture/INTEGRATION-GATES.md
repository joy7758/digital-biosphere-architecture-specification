...
result=IMPLEMENTED_CURRENT_SOURCE_FULL_EMULATED_WORKLOAD_REBASE_PASS_NATIVE_REQUIRED_PR_G2A_PACKET_REFRESH_REQUIRED_NOT_APPROVED
...
模拟 workload 重基线已形成，但原生 x86_64 与新的 independent review packet 尚未形成。
...
evidence_refs=PR-G2A-CURRENT-SOURCE-LOAD-REBASE-SUPPLEMENT-ATTESTATION-2026-07-23.json_AND_DBOS_3f5b848_REMOTE_RECEIPT_AND_PREDECESSOR_PACKET_HISTORY
observed_version_or_commit=SOURCE_23c8f08_RECEIPT_3f5b848_MANIFEST_43382e42
positive_checks=534_TESTS_200_TELEMETRY_TESTS_30_VALIDATORS_PASS_5_EXTERNAL_SOURCE_FAIL_CLOSED_0_UNEXPECTED_P001_TO_P005_INTEGRITY_SOURCE_PASS_ZERO_AUTHORITY_EFFECTS
...
`NOT_READY_CURRENT_SOURCE_PACKET_REFRESH_REQUIRED_NOT_APPROVED` 表示当前 source 五项模拟
workload 重基线已完成，但原生 x86_64 与新的 independent review packet 仍缺失，尚不能进入
