...
negative_checks=2_OPEN_HIGH_SECURITY_FINDINGS_2_SCOPED_MEDIUM_RESIDUALS_HUMAN_SECURITY_REVIEW_INCOMPLETE_23_DQ020_CASES_BLOCKED_NO_LISTENER_NO_COLLECTOR_NO_SAEE_NO_GATE_APPROVAL
...
security_precheck_ref=PR-G2A-HUMAN-SECURITY-REVIEW-PREPARATION-2026-07-23.json
security_precheck_complete=true
security_precheck_open_high_findings=2
security_precheck_open_medium_residuals=2
human_security_review_complete=false
current_source_packet_status=SECURITY_PRECHECK_BLOCKED_REMEDIATION_OR_SCOPED_RISK_ACCEPTANCE_REQUIRED
result=NOT_READY_SECURITY_REMEDIATION_OR_SCOPED_RISK_ACCEPTANCE_REQUIRED_NOT_APPROVED
