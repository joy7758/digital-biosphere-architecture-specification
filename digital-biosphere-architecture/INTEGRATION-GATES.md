...
evidence_refs=PR-G2A-TELEMETRY-ADMISSION-HARDENED-HUMAN-REVIEW-PACKET.json_AND_PR-G2A-LINUX-ARM64-REFERENCE-VALIDATION-SUPPLEMENT-ATTESTATION-2026-07-22.json_AND_PR-G2A-LINUX-X86-64-EMULATED-COMPATIBILITY-SUPPLEMENT-ATTESTATION-2026-07-23.json_AND_DBOS_8c6ddd7_REMOTE_RECEIPT
observed_version_or_commit=SOURCE_d62b411_RECEIPT_8c6ddd7_MANIFEST_6d1bcbbf
positive_checks=534_TESTS_200_TELEMETRY_TESTS_30_VALIDATORS_PASS_5_EXTERNAL_SOURCE_FAIL_CLOSED_0_UNEXPECTED_68_OTEL_CASES_LINUX_ARM64_NATIVE_PASS_AMD64_EMULATED_TA_P005_59_OF_59_PLUS_FINAL_PASS
negative_checks=AMD64_EMULATED_TA_P003_426_STORAGE_UNAVAILABLE_23_DQ020_CASES_BLOCKED_ZERO_AUTHORITY_EFFECTS_NO_LISTENER_NO_COLLECTOR_NO_SAEE
...
result=READY_FOR_HUMAN_REVIEW_LINUX_ARM64_NATIVE_PASS_X86_64_EMULATED_PARTIAL_REMOTE_ATTESTED_NOT_APPROVED
reviewed_by_ref=codex_independent_technical_review
attested_by_ref=codex_clean_clone_validation
reviewed_at=2026-07-22
x86_64_emulated_supplement_attested_at=2026-07-23T03:36:48+08:00
next_gate=HUMAN_PR_G2A_DECISION
```

`READY_FOR_HUMAN_REVIEW_REMOTE_ATTESTED_NOT_APPROVED` 是审查输入，不是 gate `PASS`。完整 `PR-G2` 仍为
`BLOCKED`。
