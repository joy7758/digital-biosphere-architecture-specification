...
| `PR-G2A` | `P0` | 是否批准 DQ-018 exact hardened offline Telemetry Admission reference slice 通过阶段闸门？ | `READY_FOR_HUMAN_DECISION_HARDENED_PACKET_REMOTE_ATTESTED_AGENT_RECOMMENDS_APPROVE` | [Hardened Human Review Packet](PR-G2A-TELEMETRY-ADMISSION-HARDENED-HUMAN-REVIEW-PACKET.md) / [JSON](PR-G2A-TELEMETRY-ADMISSION-HARDENED-HUMAN-REVIEW-PACKET.json)；[successor attestation](PR-G2A-HARDENED-HUMAN-REVIEW-PACKET-ATTESTATION-2026-07-22.md) / [JSON](PR-G2A-HARDENED-HUMAN-REVIEW-PACKET-ATTESTATION-2026-07-22.json)；predecessor packet/attestation 保留历史；source `3a63161…`、receipt `bf1b3b6…`、manifest `b6c03faf…` | 只决定 PR-G2A；批准后允许 DQ-019 candidate input review 继续；不批准完整 PR-G2 或任何部署 | Successor attestation、Agent recommendation、532 tests、TA-P001—P005、68 OTel cases 或 reproducible wheel 自动等于 Human Approval |
