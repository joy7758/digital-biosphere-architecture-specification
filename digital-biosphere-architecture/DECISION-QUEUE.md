...
| `PR-G2A` | `P0` | 是否批准 DQ-018 exact hardened offline Telemetry Admission reference slice 通过阶段闸门？ | `READY_FOR_HUMAN_DECISION_LINUX_ARM64_NATIVE_PASS_X86_64_EMULATED_PARTIAL_NOT_APPROVED` | [Hardened Human Review Packet](PR-G2A-TELEMETRY-ADMISSION-HARDENED-HUMAN-REVIEW-PACKET.md) / [JSON](PR-G2A-TELEMETRY-ADMISSION-HARDENED-HUMAN-REVIEW-PACKET.json)；[Linux arm64 supplement](PR-G2A-LINUX-ARM64-REFERENCE-VALIDATION-SUPPLEMENT-2026-07-22.md) / [JSON](PR-G2A-LINUX-ARM64-REFERENCE-VALIDATION-SUPPLEMENT-2026-07-22.json)；[arm64 attestation](PR-G2A-LINUX-ARM64-REFERENCE-VALIDATION-SUPPLEMENT-ATTESTATION-2026-07-22.json)；[x86_64 emulated supplement](PR-G2A-LINUX-X86-64-EMULATED-COMPATIBILITY-SUPPLEMENT-2026-07-23.md) / [JSON](PR-G2A-LINUX-X86-64-EMULATED-COMPATIBILITY-SUPPLEMENT-2026-07-23.json)；source `d62b411…`、receipt `8c6ddd7…` | 只决定 PR-G2A；不批准完整 PR-G2 或部署；原生 x86_64 未验证事实必须保留 | Supplement、attestation、Agent recommendation、534 tests、一小时 integrity 或 emulation 自动等于 Human Approval/native validation |
