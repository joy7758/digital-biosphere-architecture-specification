...
| `PR-G2A` | `P0` | 是否批准 DQ-018 exact hardened offline Telemetry Admission reference slice 通过阶段闸门？ | `READY_FOR_HUMAN_DECISION_LINUX_ARM64_SUPPLEMENT_REMOTE_VERIFIED_NOT_APPROVED` | [Hardened Human Review Packet](PR-G2A-TELEMETRY-ADMISSION-HARDENED-HUMAN-REVIEW-PACKET.md) / [JSON](PR-G2A-TELEMETRY-ADMISSION-HARDENED-HUMAN-REVIEW-PACKET.json)；[Linux arm64 supplement](PR-G2A-LINUX-ARM64-REFERENCE-VALIDATION-SUPPLEMENT-2026-07-22.md) / [JSON](PR-G2A-LINUX-ARM64-REFERENCE-VALIDATION-SUPPLEMENT-2026-07-22.json)；历史 packet/attestation 保留；source `57c7b9e…`、receipt `1c8f3d9…`、manifest `d0951d6c…` | 只决定 PR-G2A；批准后允许 DQ-019 candidate input review 继续；不批准完整 PR-G2 或任何部署 | Supplement、remote clean clone、Agent recommendation、533 tests、TA-P001—P005、68 OTel cases 或 reproducible wheel 自动等于 Human Approval |
