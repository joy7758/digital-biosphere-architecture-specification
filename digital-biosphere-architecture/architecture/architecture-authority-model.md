...
Program Authority 负责对 Project Portfolio、优先级、Master Roadmap、跨项目依赖、Decision Queue、Integration Gates、Risk 和 Blocker 作显式项目群决定。DBA 只定义和记录这一角色；v0.1 不把角色指派给个人、组织、账号或智能体。
