...
export const repositoryBaselines = [
  {
    ...
    labelZh: "架构治理",
    commit: "91928e3b1096566aad5568124707e3a6cb3a40ca",
...
export const gateRows = [
  ...
  },
  {
    ...
    state: "BLOCKED",
    zh: "技术试用包已冻结，但真实参与者来源尚未确认；试用未启动，参与者为 0。",
    en: "The technical trial package is frozen, but no real participant source is confirmed; the trial has not started and participant count is 0.",
  },
  {
...
export const content = {
  zh: {
    ...
    developersBody:
      "架构规范与 SAEE 只读适配器已经公开；DBOS 当前仍限制访问。技术试用包已通过干净检出，但真实参与者来源尚未确认；开始前请先阅读状态和边界，不要把验证通过理解为正式发布。",
    developerLinks: ["阅读架构规范", "读取机器状态", "供智能体读取"],
    governanceTitle: "公开前仍需完成",
    governanceItems: [
      "确认 3–5 名真实外部开发者或明确招募渠道",
      "按 PRIVATE_COLLABORATOR_TRIAL 逐人验证 DBOS 访问",
      "完成 3–5 名外部开发者试用",
      "形成明确的人工发布决定",
    ],
    legal:
  ...
  en: {
    ...
    developersBody:
      "The architecture specification and read-only SAEE adapter are public. DBOS access remains restricted. The technical trial package passed clean-clone validation, but no real participant source is confirmed. Read status and boundaries before treating validation as a release.",
    developerLinks: ["Read architecture", "Read machine status", "Read as an agent"],
    governanceTitle: "Still required before release",
    governanceItems: [
      "Confirm 3–5 real external developers or an explicit recruitment channel",
      "Validate DBOS access per participant under PRIVATE_COLLABORATOR_TRIAL",
